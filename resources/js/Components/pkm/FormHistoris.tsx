        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 space-y-5">
                ...
                <div className="w-full">
                    <MapLocationPicker
                        className="h-[400px] w-full rounded-xl overflow-hidden shadow-inner border border-zinc-200"
...
FormHistoris.getInitialData = (listJenisPkm: any[]) => ({
    ...
    kelurahan_desa: '',
    alamat_lengkap: '',
    latitude: -5.147665 as number | null,
    longitude: 119.432731 as number | null,
    total_anggaran: '', 
