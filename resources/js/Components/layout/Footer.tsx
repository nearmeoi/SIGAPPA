                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li className="flex justify-between">
                                    ...
                                    <strong className="text-white">{formatNumberID(stats.today_views)}</strong>
                                </li>
                                <li className="flex justify-between">
                                    <span className="text-slate-400">Today&apos;s Visitors:</span>
                                    <strong className="text-white">{formatNumberID(stats.today_visitors)}</strong>
                                </li>
                                <li className="flex justify-between">
                                    <span className="text-slate-400">Last 7 Days Views:</span>
                                    <strong className="text-white">{formatNumberID(stats.last_7_days_views)}</strong>
                                </li>
                                <li className="flex justify-between">
                                    <span className="text-slate-400">Last 30 Days Views:</span>
                                    <strong className="text-white">{formatNumberID(stats.last_30_days_views)}</strong>
                                </li>
                                <li className="flex justify-between">
                                    <span className="text-slate-400">Total Visitors:</span>
                                    <strong className="text-white">{formatNumberID(stats.total_visitors)}</strong>
                                </li>
                            </ul>
                        </div>
                    </div>
