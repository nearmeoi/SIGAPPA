...
import { fixLeafletDefaultIcon } from '@/utils/leafletSetup';
...
import MobileSplashScreen from '@/Components/layout/MobileSplashScreen';
...
export default function LandingMapMobile({ pkmData = [] }: LandingPageMobileProps) {
