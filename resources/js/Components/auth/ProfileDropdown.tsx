...
export default function ProfileDropdown({ auth: propsAuth }: ProfileDropdownProps) {
    ...
    return (
        <div className="relative" ref={shellRef}>
            ...
            <button
                type="button"
                className={`flex items-center justify-center p-1 bg-white border border-slate-200 hover:border-slate-300 rounded-full transition-all duration-200 hover:shadow-sm focus:outline-none ${isOpen ? 'shadow-sm ring-2 ring-poltekpar-primary/20' : ''
                    }`}
