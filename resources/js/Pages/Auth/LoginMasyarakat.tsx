...
import LoginMasyarakatMobile from '@/Components/auth/LoginMasyarakatMobile';
...
}: LoginMasyarakatProps): React.ReactNode {
        ...
        <Layout mainClassName="site-main-content site-main-content--landing-balanced" mainStyle={{ flex: '0 0 auto' }}>
            ...
            <div className="landing-page login-dosen-page">
                <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 py-8">
                    <PkmMapDashboardCard pkmData={pkmData} watchKey="login-masyarakat-map" />
                </div>
