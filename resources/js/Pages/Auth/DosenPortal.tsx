...
export default function DosenPortal({ initialNip = null, autoCheck = false }: DosenPortalProps) {
                                        ...
                                        <div className="input-group">
                                            ...
                                            <div className="input-wrapper">
                                                ...
                                                <button
                                                    ...
                                                    title={showPasswordConfirmation ? "Sembunyikan konfirmasi kata sandi" : "Tampilkan konfirmasi kata sandi"}
                                                >
                                                    <i className={`fa-regular ${showPasswordConfirmation ? 'fa-eye-slash' : 'fa-eye'}`}></i>
                                                </button>
                                            </div>
                                        </div>
                                    )}
